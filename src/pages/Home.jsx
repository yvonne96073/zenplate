...
const FOOD_EMOJI_MAP = [
  // ── 手搖飲料（最優先，避免被其他 pattern 誤中）──────────────
  [/珍珠奶茶|珍奶|波霸奶茶|波霸|珍珠紅茶|珍珠|手搖飲|手搖/, '🧋'],
  [/奶茶|鮮奶茶|烏龍拿鐵|重燒烏龍|重焙烏龍|阿薩姆鮮奶|四季春鮮奶|烏龍奶/, '🧋'],
  [/黑糖鮮奶|黑糖珍珠|黑糖奶|多多綠|百香多多|仙草奶茶|芋頭鮮奶|鮮芋珍珠/, '🧋'],
  [/奶蓋|芝士奶蓋|起司奶蓋|cheese foam/i, '🧋'],
  // ── 穀物 / 澱粉 ─────────────────────────────────────────────
  [/飯|白飯|炒飯|米飯|糙米|粥/, '🍚'],
  [/拉麵|泡麵|烏龍麵|義大利麵|冬粉|河粉|米粉|麵線|涼麵/, '🍜'],
  [/麵包|吐司|貝果|可頌/, '🍞'],
