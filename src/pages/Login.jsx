  ...
  return (
    <div className="login-bg">
      <div className="login-box">
        ...
        {/* ── In-app browser: block Google OAuth, show open-in-browser ── */}
        {inApp ? (
          <div className="inapp-warning">
            <p className="inapp-warning-title">🌐 請在 Safari 開啟</p>
            <p className="inapp-warning-body">
              目前在 Messenger 內建瀏覽器，Google 登入被 Google 封鎖。<br/>
              點下方按鈕直接跳到 Safari：
            </p>
            ...
            {openFailed && (
              <>
                <p className="inapp-warning-body" style={{ marginTop: 10, marginBottom: 6 }}>
                  自動跳轉失敗，請手動複製連結：
                </p>
                <button className="inapp-copy-btn" onClick={handleCopyLink}>
                  📋 複製連結
                </button>
              </>
            )}
            <p className="inapp-hint">或直接用 Email 登入（不需要 Safari）↓</p>
          </div>
        ) : (
